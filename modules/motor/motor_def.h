...
#define pitch_limit_min  -8.0f   // pitch最大仰起限位（IMU Roll，度；对应电机+0.14 rad）
#define pitch_limit_max  45.8f   // pitch最大俯下限位（IMU Roll，度；对应电机-0.8 rad）
#define PITCH_MID_DEG    1.0f   // 云台pitch中值位置（在限制范围内的合理中间值）
/**
